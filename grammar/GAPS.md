...
| GAP-5 | file-granular path_ref (dotted components: `spec/TERMS.md`) | repo-policy fidelity to skill frontmatter scopes | OPEN — **pinned by corpus 022** (G8); until closed, actor scopes are directory-granular |
