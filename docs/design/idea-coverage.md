...
| Config resolution | 0 | **0** | converges with north-star metric #1 (resolution rate ≈ 0%). `use` resolves to nothing | none | **the gateway gate**: resolver = G1-enablement rungs 1–2 |
